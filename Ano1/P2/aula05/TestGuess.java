...
public class TestGuess {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Bem vindo ao melhor jogo de sempre, mas primeiro escolha um limite minimo e um maximo");
    int min = scin.nextInt();
    int max = scin.nextInt();
    if (args.length == 2) {
  ...
  static void playGame(int n, GuessGame game){
        game.play(n); 
        if(!game.validAttempt()) out.printf("%d is out of bounds", n);
		else if(game.attemptIsHigher()) out.printf("%d is too high!", n);
