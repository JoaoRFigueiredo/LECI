...
typedef struct
{
   ...
   pthread_mutex_t access; //numtex de acesso ao fifo
   pthread_cond_t isNotFull;  //variavel de condição, para quando o fifo não está cheio
   pthread_cond_t isNotEmpty; //variavel de condiçao para quando o fifo não está vazio
