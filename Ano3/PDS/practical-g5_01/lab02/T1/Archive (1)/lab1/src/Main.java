    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for(String wrd : words) {
                ...
                switch (direction) {
                    case VERTICAL_UP : incY = -1; break;
                    case DIAGONAL_UP_RIGHT : incX = 1; incY = -1; break;
                    case HORIZONTAL_RIGHT : incX = 1; break;
                    case DIAGONAL_DOWN_RIGHT :  incX = 1; incY = 1; break;
                    case VERTICAL_DOWN : incY = 1; break;
                    case DIAGONAL_DOWN_LEFT :  incX = -1; incY = 1; break;
                    case HORIZONTAL_LEFT : incX = -1; break;
                    case DIAGONAL_UP_LEFT : incX = -1; incY = -1; break;
