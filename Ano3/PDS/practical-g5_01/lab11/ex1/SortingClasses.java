...
class BubbleSort implements PhoneSortingTragedy {
...
class InsertionSort implements PhoneSortingTragedy {
    public void sort(Phone[] phones, String criteria) {
        int n = phones.length;
        for (int i = 1; i < n; ++i) {
            Phone key = phones[i];
...
class QuickSort implements PhoneSortingTragedy {
    public void sort(Phone[] phones, String criteria) {
...
class MergeSort implements PhoneSortingTragedy {
    public void sort(Phone[] phones, String criteria) {
