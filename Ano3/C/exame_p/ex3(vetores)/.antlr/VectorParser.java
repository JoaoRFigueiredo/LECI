...
public class VectorParser extends Parser {
	...
	public static class ExprMultInterContext extends ExprContext {
		public Token op;
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		...
		public ExprMultInterContext(ExprContext ctx) { copyFrom(ctx); }
	}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new ExprMultInterContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(43);
						if (!(precpred(_ctx, 6))) throw new FailedPredicateException(this, "precpred(_ctx, 6)");
						setState(44);
						((ExprMultInterContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==T__5 || _la==T__6) ) {
							((ExprMultInterContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
	...
	public static final String _serializedATN =
		...
		"\20\2\2 \t\3\2\2\2!\"\b\6\1\2\"#\t\2\2\2#,\5\n\6\t$%\7\n\2\2%&\5\n\6\2"+
		"&\'\7\13\2\2\',\3\2\2\2(,\7\r\2\2),\7\f\2\2*,\7\20\2\2+!\3\2\2\2+$\3\2"+
