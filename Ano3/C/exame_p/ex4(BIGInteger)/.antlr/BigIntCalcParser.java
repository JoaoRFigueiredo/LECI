...
public class BigIntCalcParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_stat = 1, RULE_show = 2, RULE_assignment = 3, RULE_expr = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "stat", "show", "assignment", "expr"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__4) | (1L << T__8) | (1L << BIGINT) | (1L << ID))) != 0)) {
				{
				{
				setState(10);
				stat();
	...
	public static class ExprBigContext extends ExprContext {
		public TerminalNode BIGINT() { return getToken(BigIntCalcParser.BIGINT, 0); }
		public ExprBigContext(ExprContext ctx) { copyFrom(ctx); }
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case BIGINT:
				{
				_localctx = new ExprBigContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(38);
				match(BIGINT);
	...
	public static final String _serializedATN =
		...
		"\2\2\33\34\5\n\6\2\34\7\3\2\2\2\35\36\5\n\6\2\36\37\7\5\2\2\37 \7\16\2"+
		"\2 \t\3\2\2\2!\"\b\6\1\2\"#\t\2\2\2#+\5\n\6\b$%\7\13\2\2%&\5\n\6\2&\'"+
		"\7\f\2\2\'+\3\2\2\2(+\7\r\2\2)+\7\16\2\2*!\3\2\2\2*$\3\2\2\2*(\3\2\2\2"+
		"*)\3\2\2\2+\64\3\2\2\2,-\f\7\2\2-.\t\3\2\2.\63\5\n\6\b/\60\f\6\2\2\60"+
		"\61\t\2\2\2\61\63\5\n\6\7\62,\3\2\2\2\62/\3\2\2\2\63\66\3\2\2\2\64\62"+
		"\3\2\2\2\64\65\3\2\2\2\65\13\3\2\2\2\66\64\3\2\2\2\7\17\26*\62\64";
