...
public class Ex {
    ...
    //Versão com uso de streams no ex2
    ...
    filmes.stream().filter(mov -> mov.getScore() > 60)
            .filter(mov -> mov.getGenre().equalsIgnoreCase("comedy"))
            .sorted((a1, a2) -> Double.compare(a1.getScore(), a2.getScore()))
            .forEach(m -> pw.write(m+"\n"));
